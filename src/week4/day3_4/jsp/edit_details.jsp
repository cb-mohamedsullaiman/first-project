...
<html>
    ...
    <body>
        <%
                ...
                String state = null;
                String country = null;
                ResultSet resultSet = DAOImplementation.select("* from phone_directory_portal.users where email = ?",session.getAttribute("email")); 
                if(resultSet.next()){
        ...
        <form class="container" method="POST" action="/myPhoneDirectory/save">          
            <table>
                <tr>
                    <td class="header">
                        NAME
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="http://localhost:8080/myPhoneDirectory/welcome.jsp">Discard</a>
                    </td>
                </tr>
            </table>  
            <% 
